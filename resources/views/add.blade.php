...
<body>
    ...
    <form action="{{route('insert.pos')}}" method="post" class="w-50 m-auto">
        ...
        <div class="row bg-primary opacity-25">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="CodeProprietaire" id="exampleInputCode_proprietaire" aria-describedby="emailHelp">
                <div id="emailHelp" class="form-text">veiller remplir votre cote svp.</div>
            </div>

            <label for="exampleInputNom" class="form-label">Nom</label>
                <input type="text" class="form-control" name="Nom_proprietaire" id="exampleInputEmail1" aria-describedby="emailHelp">
            ...
            <label for="exampleInputNom" class="form-label">Prenom</label>
                <input type="text" class="form-control" name="Prenom_proprietaire" id="exampleInputEmail1" aria-describedby="emailHelp">
            ...
            <label for="exampleInputDate_naissance" class="form-label">Date_naissance</label>
                <input type="date" class="form-control" name="Date_naissance" id="exampleInputDate_naissance" aria-describedby="emailHelp">
            ...
            <label for="exampleInputEmail1" class="form-label">Lieu_naissance</label>
                <input type="text" class="form-control" name="Lieu_naissance" id="exampleInputEmail1" aria-describedby="emailHelp">
            ...
            <label for="exampleInputEmail1" class="form-label">code_piece_identite</label>
                <input type="number" class="form-control" name="code_piece_identite" id="exampleInputEmail1" aria-describedby="emailHelp">
            ...
            <label for="exampleInputEmail1" class="form-label">Numero_piece_identite</label>
                <input type="number" class="form-control" name="Numero_piece_identite" id="exampleInputEmail1" aria-describedby="emailHelp">
